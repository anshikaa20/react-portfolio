    ...
    <div className="border-b border-transparent pb-4">
      <div className="my-20 text-center text-4xl">
        <div className="flex justify-center items-center">
          ...
          className="bg-gradient-to-r from-blue-800 via-slate-700 to-pink-800 bg-clip-text tracking-tight text-transparent">
            Projects
          </motion.h2>
        </div>
      </div>
      <div>
        {PROJECTS.map((project, index) => (
          <div key={index} className="mb-8 flex flex-wrap lg:justify-center">
            ...
            initial={{opacity:0,x:100}}
            transition={{duration:1}}
            className="w-full max-w-xl lg:1/3 p-4">
              <h6 className="mb-2 font-semibold text-purple-600">{project.title}</h6>
